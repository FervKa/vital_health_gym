    ...
    if op == 1:
        while True:
            ...
            if op1 == 1:
                ...
                michael_gym.add_client(client_id, client_name, client_last_name, client_age, client_phone, True, opcion ,True, fecha_formateada, False)
            if op1 == 2:
                ...
                print(client)
                print(f"The user with id: {id_customer} and name {client.sget_name} was found in the database succefully")
            if op1 == 3:
    ...
    if op == 2:
        while True:
            ...
            if op2 == 3:
                ...
                print(f"The membership of the client with id: {id_customer} was disabled succefully")
